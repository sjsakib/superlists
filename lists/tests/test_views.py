...
class ListViewTest(TestCase):
    ...
    def test_passes_correct_list_to_the_template(self):
        # A list other than the correct one
        List.objects.create()
        correct_list = List.objects.create()
        response = self.client.get(f'/lists/{correct_list.id}/')
    ...
    def test_for_invalid_input_renders_list_templage(self):
...
class TestShareList(TestCase):
    ...
    def test_POST_adds_user_to_shared_with_set(self):
        list_ = List.objects.create()
        user = User.objects.create(email='a@b.com')

        self.client.post(f'/lists/{list_.id}/share',
